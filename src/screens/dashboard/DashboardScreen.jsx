...
//   Payments: ['Indent', 'Purchase Order', 'Good Receive Note', 'Bill Payment', 'Expense'],
//   'Work Order': ['Work Order', 'Advance Payment', 'Bill', 'Bill Payment'],
//   Inventory: [], // Empty array as per original code
//   Approvals: ['RFI', 'Snagging Report', 'Inspection', 'Submittals'],
//   Reports: ['Daily Progress', 'Activity Timelines', 'Material Consumption'],
// };
...
//   const handleFilterSelect = (filter) => {
//     if (filter === 'Inventory') {
//       // Directly navigate to InventoryScreen since Inventory has no dropdown items
//       navigation.navigate('Inventory');
//       setSelectedFilter(null); // Reset filter to avoid dropdown issues
//       setSelectedSubItem(null);
...
//   };
//  // header card of 
//  //can we keep the format like project name and at opposite end the percent of completion below it 
//  // status of construction 
//  //below it duration and at end of the it the budget of it so it looks good then
//   const ProjectHeaderCard = () => (
//     <Animated.View
//       style={{
//         opacity: fadeAnim,
...
//     >
//       <LinearGradient
//         // colors={['#4e75f5ff', '#458bfcff', '#60A5FA']}
//         // colors={['#4ea7f5ff', '#67a1ffff', '#60A5FA']}
...
//                 }}
//               >
//                 <Text style={{ color: 'white', fontSize: 12, fontWeight: '600' }}>{project?.status}</Text>
//               </View>
//               <Text style={{ color: 'rgba(255,255,255,0.9)', fontSize: 14 }}>{project?.duration}</Text>
//             </View>
//             <Text style={{ color: 'rgba(255,255,255,0.9)', fontSize: 16, fontWeight: '600' }}>
//               Budget: {project?.amount}
//             </Text>
//           </View>
//           <View style={{ alignItems: 'flex-end' }}>
//             <Text style={{ color: 'white', fontSize: 32, fontWeight: '800' }}>{project?.progress}</Text>
//             <Text style={{ color: 'rgba(255,255,255,0.8)', fontSize: 12 }}>Complete</Text>
//           </View>
//         </View>
//       </LinearGradient>
//     </Animated.View>
...
// //make the duration number budget amount more higlighted that user must be ease to understand them and 
// // 2nd thing the icons that are used to the project stats are like clipbpard based can you instead import them from some source
// //also remove the shadow to cards, stats, tabs //like remove the shadow from everywhere
// import React, { useState, useEffect } from 'react';
// import { View, Text, ScrollView, TouchableOpacity, Dimensions, Animated } from 'react-native';
// import { useRoute, useNavigation } from '@react-navigation/native';
// import MainLayout from '../components/MainLayout';
...
//             fontWeight: '500',
//             color: colors.textMuted,
//             marginBottom: item.trend ? 4 : 0, // Fixed: Changed item.change to item.trend
//           }}
//         >
//           {item.subheading}
//         </Text>
...
//   // Debugging log to check cardData
//   if (!cardData || !Array.isArray(cardData)) {
//     console.error('cardData is undefined or not an array:', cardData);
//   }
