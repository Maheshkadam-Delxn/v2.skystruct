...
// // Filter options with sub-items
// const filterOptions = [
//   { 
//     name: 'Project Resources',
//     subItems: ['Bill of Quantity', 'Drawing', 'Documents'],
//     defaultSubItem: 'Bill of Quantity'
//   },
//   { 
//     name: 'Project Planning',
//     subItems: ['Activity', 'Project Planner', 'Resource'],
//     defaultSubItem: 'Activity'
//   },
//   { 
//     name: 'Payment',
//     subItems: ['Indent', 'Purchase Order', 'Good Receive Note', 'Bill Payment', 'Expense'],
//     defaultSubItem: 'Indent'
//   },
//   { 
//     name: 'Work Order',
//     subItems: ['Work Order', 'Advance Payment', 'Bill', 'Bill Payment'],
//     defaultSubItem: 'Work Order'
//   },
//   { 
//     name: 'Inventory',
//     subItems: [],
//     defaultSubItem: 'Inventory'
//   },
//   { 
//     name: 'Approvals',
//     subItems: ['RFI', 'Snagging Report', 'Inspection', 'Submittals'],
//     defaultSubItem: 'RFI'
//   },
//   { 
//     name: 'Reports',
//     subItems: ['Daily Progress', 'Activity Timelines', 'Material Consumption'],
//     defaultSubItem: 'Daily Progress'
//   },
// ];
...
//   const [selectedSubItem, setSelectedSubItem] = useState(filterOptions[0].defaultSubItem);
//   const [expandedFilter, setExpandedFilter] = useState(null);
//   const [animation] = useState(new Animated.Value(0));

//   // Toggle dropdown for a filter
...
//   const handleFilterSelect = (filterName, subItem = null) => {
...
//       setExpandedFilter(null);
//     } else if (filter.subItems.length > 0) {
//       // Toggle dropdown if there are sub-items
//       toggleDropdown(filterName);
//     } else {
//       // Select the filter directly if no sub-items
//       setSelectedFilter(filterName);
//       setSelectedSubItem(filter.defaultSubItem);
//       setExpandedFilter(null);
//     }
//   };
...
//               const hasSubItems = filter.subItems.length > 0;
              
//               return (
//                 <View key={filter.name} className="mr-3 relative z-50">
//                   <TouchableOpacity
...
//                     </Text>
//                     {hasSubItems && (
//                       <Text className={`ml-2 ${isSelected ? 'text-white' : 'text-gray-600'}`}>
//                         {isExpanded ? '▲' : '▼'}
//                       </Text>
//                     )}
//                   </TouchableOpacity>
...
//                     <View 
//                       className="absolute top-full left-0 mt-1 bg-white rounded-lg shadow-lg z-50 min-w-full border border-gray-200"
//                       style={{
//                         elevation: 10,
//                         shadowColor: '#000',
...
//                         const isSubItemSelected = selectedSubItem === subItem && selectedFilter === filter.name;
                        
//                         return (
//                           <TouchableOpacity
//                             key={subItem}
//                             onPress={() => handleFilterSelect(filter.name, subItem)}
//                             className={`px-4 py-3 border-b border-gray-100 ${
//                               isSubItemSelected ? 'bg-blue-50' : 'bg-white'
//                             }`}
//                           >
//                             <Text
//                               className={`${
//                                 isSubItemSelected ? 'text-blue-600 font-semibold' : 'text-gray-700'
//                               }`}
//                             >
//                               {subItem}
//                             </Text>
...
//       // Toggle dropdown if same filter is clicked
//       setDropdownVisible(!dropdownVisible);
//     } else {
//       // Select new filter and show dropdown if it has items
//       setSelectedFilter(filter);
//       if (dropdownItems[filter] && dropdownItems[filter].length > 0) {
...
//           className="mb-4"
//           // This ensures the scrollview is always scrollable
//           style={{ maxHeight: dropdownVisible ? 50 : 'auto' }}
//         >
//           <View className="flex-row">
//             {filterOptions.map((filter, index) => (
//               <TouchableOpacity
...
//                   selectedFilter === filter && dropdownVisible ? (
//                     <Text style={{ color: selectedFilter === filter ? 'white' : '#6B7280', fontSize: 12, marginLeft: 4 }}>▲</Text>
//                   ) : (
//                     <Text style={{ color: selectedFilter === filter ? 'white' : '#6B7280', fontSize: 12, marginLeft: 4 }}>▼</Text>
//                   )
//                 )}
...
//         {/* Dropdown positioned below the filter */}
//         {dropdownVisible && (
//           <View className="bg-white rounded-lg shadow-lg mt-2 border border-gray-200">
//             {dropdownItems[selectedFilter]?.map((item, index) => (
//               <TouchableOpacity
//                 key={index}
//                 className={`px-6 py-4 border-b border-gray-100 ${
//                   selectedSubItem === item ? 'bg-blue-50' : ''
//                 }`}
  ...
  return (
    <MainLayout title={project ? project.name : 'Project Dashboard'}>
      ...
      <View className="bg-blue-100 px-6 pb-6 pt-14 shadow-sm">
        ...
        {/* Sub-items displayed immediately below the selected filter */}
        {dropdownItems[selectedFilter] && dropdownItems[selectedFilter].length > 0 && (
